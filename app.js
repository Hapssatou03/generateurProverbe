// Créer un Générateur de proverbe
...
// Déclarer mes variables et lui donner une valeur à l'index 0
let dernier = 0
let nombreAleatoire = 0

// Recuperer les éléments à parametrer

let Citation = document.querySelector('#citation')
let auteur = document.querySelector('#auteur')
let nouveau = document.querySelector('#nouveau')

//  fonction qui  permet de générer un nombre entier avec Math.floor/ Math.radom(génére les nombres décimaux)
...
// Détecter les événement au click du boutton

nouveau.addEventListener('click', () => {
// créer la boucle do while
  do  {
...
// afficher nos citations sur la page en les stockants dans les variables
